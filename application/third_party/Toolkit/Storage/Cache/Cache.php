 ...
 */
include __DIR__ . DIRECTORY_SEPARATOR . 'drivers' . DIRECTORY_SEPARATOR . Config::get('cache.default.adapter') . '_driver.php';

/**
 * Initialize static class, it will be calling initialization
 * method before calling static methods.
 *
